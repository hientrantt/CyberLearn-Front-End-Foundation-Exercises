        ...
        venobox: function(options) {
            ...
            return this.each(function() {
                ...
                obj.on('click', function(e){
                    ...
                    // set a different url to be loaded using data-="" - thanx @pixeline
                ...
                function loadVid(autoplay){
                    ...
                    if (videoObj.type == 'vimeo') {
                      ...
                      player = 'https://fiverr-res.cloudinary.com/video/upload/t_fiverr_hd/';
                    }
                ...
                */
                function parseVideo (url) {
                    ...
                    url.match(/(http:|https:|)\/\/(player.|www.)?(vimeo\.com|youtu(be\.com|\.be|be\.googleapis\.com))\/(video\/|embed\/|v=|v\/)?([A-Za-z0-9._%-]*)(\&\S+)?/);
                    var type;
